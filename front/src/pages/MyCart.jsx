...
useEffect(() => {
  ...
  console.log("image-url", item.coverImageUrl);
              return(
                        <div key={item.documentId} className="w-full flex gap-[25px] items-center px-[60px] p-[24px] bg-[#FFFFFF]">
            <div className="w-[535px] flex gap-[24px]">
                ...
                <div className=' w-full flex flex-col gap-[35px]'>
                    ...
                    <div className='w-full flex flex-col gap-[32px]'>
                        ...
                        <div className='w-[655px] items-center  flex gap-[147px]'>
                ...
                <p className='text-[30px] text-[#000000] font-semibold'>{item.price}</p>
                <p className='text-[30px] text-[#000000] font-semibold'>{item.price * item.qty}</p>

                <button className='w-[24px] h-[24px] bg-transparent border-0 '
        ...
        <div className="w-full flex flex-col gap-[40px]">
            <div className='w-full flex flex-col gap-[24px]'>
                <div className="w-full flex flex-col gap-[24px] border-b-1 border-[#22222233] pb-[24px]">
                    <p className='w-full flex justify-between text-[24px] text-[#222222] font-semibold'><span className='text-[20px] text-[#22222280]'>Subtotal</span>${subtotal}</p>
